...
class PyCalendar:
    ...
    def get_next_session(self, dt: Union[datetime, datetime64]) -> tuple[int, int]:
    ...
    def is_trading(self, dt: Union[datetime, datetime64]) -> bool:
        """ 判断时间`dt`是否正在交易中
...
def timestamp_s(dt: Union[datetime, datetime64]) -> int:
    """
    convert datetime to unix timestamp of the resolution seconds
    """

def timestamp_ms(dt: Union[datetime, datetime64]) -> int:
    """
    convert datetime to unix timestamp of the resolution milliseconds
    """

def timestamp_us(dt: Union[datetime, datetime64]) -> int:
    """
    convert datetime to unix timestamp of the resolution microseconds
    """

def timestamp_ns(dt: Union[datetime, datetime64]) -> int:
    """
    convert datetime to unix timestamp of the resolution nanoseconds
    """

def combine(day: datetime64, time: timedelta64) -> datetime64:
    """
    like python's datetime.combine
    """

def timedelta_s(dt1: Union[datetime, datetime64], dt2: Union[datetime, datetime64]) -> int:
    """
